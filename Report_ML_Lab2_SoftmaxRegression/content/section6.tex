...
\begin{itemize}
    \item \textbf{Cải tiến phương pháp trích xuất đặc trưng:} Thay vì Block Averaging đơn giản, có thể sử dụng phương pháp HOG (Histogram of Oriented Gradients) \cite{dalal2005histograms} hoặc PCA (Principal Component Analysis) \cite{pearson1901lines} để giảm chiều dữ liệu nhưng vẫn giữ lại được các thông tin quan trọng hơn về phương sai và cấu trúc.
