...
Trước khi áp dụng thuật toán Canny, dữ liệu ảnh đầu vào được chuyển đổi sang định dạng \texttt{uint8} (số nguyên 8-bit không dấu) để tương thích với thư viện OpenCV:
\begin{center}
